...
const Project = ({ image, prjLink, title, gitLink }: IProject) => {
	return (
		<div
			className='flex flex-col font-pushster w-[200px] h-full mx-3 
		bg-[rgba(0,0,0,0.5)] rounded-md lg:w-[350px] lg:h-[350px]'
		>
			<img
